...
namespace DreamEchoesCore.Utils
{
    ...
    /// </summary>
    public static class WeaverCoreWarpOverride
    {
        /// <summary>
        ...
        static IEnumerator DoDreamnailWarpRoutine(Vector3 effectsPosition, string destinationScene, string returnScene, string gateName, float warpDelay, bool noCharms, DreamWarpOptions options)
        {
            ...
            {
                WeaverAudio.PlayAtPoint(options.DreamWarpSound, effectsPosition, channel: WeaverCore.Enums.AudioChannel.Sound);
            }
        ...
        static IEnumerator PlayDreamEntryEffectsRoutine(DreamWarpOptions options, string entryGateName)
        {
            ...
            {
                WeaverAudio.PlayAtPoint(options.DreamArriveSound, HeroController.instance.transform.position, channel: WeaverCore.Enums.AudioChannel.Sound);
            }
